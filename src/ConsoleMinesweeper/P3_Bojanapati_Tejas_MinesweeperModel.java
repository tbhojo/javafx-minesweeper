...
public class P3_Bojanapati_Tejas_MinesweeperModel implements P3_Bojanapati_Tejas_MSModelInterface{
    ...
    public boolean isGameWon() {
        return numTilesUncovered == rows * cols - numMines;
    }
    ...
    @Override
    public void markSafe(int row, int col) {
        if (isInBounds(row, col) && !isCovered[row][col] && !isFlagged[row][col]) {
